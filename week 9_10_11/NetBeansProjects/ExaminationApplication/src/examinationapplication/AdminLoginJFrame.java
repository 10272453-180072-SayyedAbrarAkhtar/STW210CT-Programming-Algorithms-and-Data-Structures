...
public class AdminLoginJFrame extends javax.swing.JFrame {
    ...
    public void login(String uname, String key) {
        ...
        try{
            ...
            if (rs.next()) {
                HomeWindowJFrame home = new HomeWindowJFrame(uname, key);
                home.show();
                dispose();
            } else {
            ...
            JOptionPane.showMessageDialog(null, "Error in login method of AdminLoginJFrame: ");
        }
