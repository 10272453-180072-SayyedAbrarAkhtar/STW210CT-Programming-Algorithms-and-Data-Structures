        ...
        )
        {
            ...
            try {
                ...
                if (resultset.next()) {
                    ...
                    query = "insert into examinee (name, username, password, gender, contact, email) values ('"+ name +"','"+ username +"','"+ password +"', '"+ gender +"','"+ contact +"','"+ email+"')";
                    ...
                    clearControls();
                    DashboardJFrame dashboard = new DashboardJFrame(username, password);
                    dashboard.show();
                    dispose();
