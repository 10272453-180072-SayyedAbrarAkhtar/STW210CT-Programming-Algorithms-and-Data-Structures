    ...
    private void btnRegisterAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterAdminActionPerformed
            ...
            )
        {
            ...
            try {
                ...
                String chkUsername = "select * from admin where username = ?";
                preparedStatement = con.prepareStatement(chkUsername);
                ...
                if (resultSet.next()) {
                    ...
                    usernameTxtField.grabFocus();
                        ...
                        String registerAdmin = "insert into admin (name, username, password, email, gender, contact) values (?,?,?,?,?,?)";
                        preparedStatement = con.prepareStatement(registerAdmin);
                ...
                JOptionPane.showMessageDialog(null, "Admin not registered: " + e);
            }
        }
